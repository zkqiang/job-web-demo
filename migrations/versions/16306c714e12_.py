...
Revision ID: 16306c714e12
Revises: 
Create Date: 2018-03-11 20:44:53.898536
...
def upgrade():
    ...
    op.create_index(op.f('ix_delivery_company_id'), 'delivery', ['company_id'], unique=False)
    op.create_index(op.f('ix_delivery_job_id'), 'delivery', ['job_id'], unique=False)
    op.create_index(op.f('ix_delivery_status'), 'delivery', ['status'], unique=False)
    op.create_index(op.f('ix_delivery_user_id'), 'delivery', ['user_id'], unique=False)
    op.create_table('job_delivery',
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('job_delivery')
    op.drop_index(op.f('ix_delivery_user_id'), table_name='delivery')
    op.drop_index(op.f('ix_delivery_status'), table_name='delivery')
    op.drop_index(op.f('ix_delivery_job_id'), table_name='delivery')
    op.drop_index(op.f('ix_delivery_company_id'), table_name='delivery')
